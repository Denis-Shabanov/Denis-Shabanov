...
| HR-аналитика: прогноз удовлетворённости и увольнений сотрудников | Построение ML-моделей для предсказания уровня удовлетворённости работой и вероятности увольнения сотрудников на основе внутренних данных компании | [Перейти к проекту](https://github.com/Denis-Shabanov/Combined_project_2) |
