...
<p align="left">Описание чего-то интересного</p>
...
|:------|:---------|:------|
| Сборный проект 1 | Анализ рынка российского кинопроката | [Перейти к проекту](https://github.com/Denis-Shabanov/Cinema_data_Russia) |
| Сборный проект 5 | Поиск референсных изображений по текстовому описанию, используя мультимодельные нейросети | [Перейти к проекту](https://github.com/Denis-Shabanov/Photos_project) |
| Финальный проект | Разработка прогнозной модели по оттоку клиентов оператора связи | [Перейти к проекту](https://github.com/Denis-Shabanov/Final_project_DS_SDD) |
