...
|:------|:---------|:------|
| Анализ рынка российского кинопроката | Исследование рынка российского кинопроката и выявление основных трендов | [Перейти к проекту](https://github.com/Denis-Shabanov/Cinema_data_Russia) |
| Поиск фото "Со смыслом" | Поиск референсных изображений по текстовому описанию, используя мультимодельные нейросети | [Перейти к проекту](https://github.com/Denis-Shabanov/Photos_project) |
| Разработка прогнозной модели по оттоку клиентов оператора связи | Создание модели машинного обучения, которая предсказывает уход клиента (отток) на основе данных о его контракте, личных характеристиках и используемых услугах | [Перейти к проекту](https://github.com/Denis-Shabanov/Final_project_DS_SDD) |
| HR-аналитика: прогноз удовлетворённости и увольнений сотрудников | Построение ML-моделей для предсказания уровня удовлетворённости работой и вероятности увольнения сотрудников на основе внутренних данных компании | [Перейти к проекту](https://github.com/Denis-Shabanov/Combined_project_2/blob/main/HR-%D0%B0%D0%BD%D0%B0%D0%BB%D0%B8%D1%82%D0%B8%D0%BA%D0%B0.ipynb) |
